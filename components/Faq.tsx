...
export default function FAQSection() {
  ...
  return (
    <div
      className="relative py-12 px-4 sm:px-6 md:px-12 text-white bg-[#080A12] overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="relative">
          ...
          <motion.button
            onClick={prevFAQ}
            className="absolute top-1/2 -left-4 sm:-left-6 transform -translate-y-1/2 bg-white text-[#080A12] rounded-full p-2 sm:p-3 shadow-lg"
          ...
          <motion.button
            onClick={nextFAQ}
            className="absolute top-1/2 -right-4 sm:-right-6 transform -translate-y-1/2 bg-white text-[#080A12] rounded-full p-2 sm:p-3 shadow-lg"
            whileHover={{ scale: 1.2 }}
            whileTap={{ scale: 0.95 }}
          >
