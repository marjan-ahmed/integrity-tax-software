...
export default function HowItWorks() {
  return (
    <section 
      className="relative py-16 px-4 md:px-8 lg:px-16 bg-[#080A12] overflow-hidden"
      style={{
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${step.color} text-[#080A12] font-bold text-lg sm:text-xl z-10`}
                >
                  {idx + 1}
                </div>
                ...
                <div className="bg-white/90 text-black shadow-lg rounded-2xl p-6 sm:p-8 mt-6 md:mt-0 md:w-3/4 mx-0 md:mx-6 backdrop-blur-sm">
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                    <Icon className={`w-8 h-8 sm:w-10 sm:h-10 text-[#080A12] flex-shrink-0`} />
