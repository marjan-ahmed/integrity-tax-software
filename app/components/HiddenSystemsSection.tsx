...
export default function HiddenSystemsSection() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 bg-gradient-to-br from-[#14353f] to-[#0f1419] text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <div className="text-lg text-gray-300 mb-2">Monthly Ad Spend Managed</div>
          ...
          >
            ...
            <div className="text-lg text-gray-300 mb-2">Lifetime Tested & Optimized</div>
        ...
        <motion.div 
          className="bg-gradient-to-r from-[#6A98FF] to-[#B8D4FF] rounded-2xl p-8 text-center mb-8"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInUp}
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 text-left">
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-bold text-lg mb-2">No following or audience?</h4>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-bold text-lg mb-2">No tech or ad experience?</h4>
              ...
              <div>
                <h4 className="font-bold text-lg mb-2">No time?</h4>
